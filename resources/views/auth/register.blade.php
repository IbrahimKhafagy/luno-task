...
<form class="row g-3" action="{{ route('register.save') }}" method="POST">
    ...
    <input type="password" id="password" for="password" name="password" class="form-control form-control-lg @error('password')is-invalid @enderror" placeholder="8+ characters required">
                    @error('password')
                      <span class="invalid-feedback">{{ $message }}</span>
                    @enderror
    </div>
    ...
    <input type="password" name="password_confirmation" id="password" class="form-control form-control-lg @error('password_confirmation')is-invalid @enderror" placeholder="8+ characters required">
    ...
    <div class="col-12 text-center mt-4">
    <span class="text-muted">Already have an account? <a href="/">Sign in here</a></span>
    </div>
</form>
